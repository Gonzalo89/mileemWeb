...
Propiedad.create([{direccion: 'PEDRO LOZANO', piso: 2, numero: 4100, departamento: 'A', barrio_id: 2, precio: 150000, moneda_id: 2,superficie: 100, ambientes: 2, tipo_propiedad_id: 2}, 
  {direccion: 'Av Corrientes', piso: '', numero: 4666, departamento: '', barrio: Barrio.find_by_nombre('Flores'), precio: 100000, moneda_id: 1,superficie: 60, ambientes: 1, tipo_propiedad_id: 1},
  {direccion: 'Murguiondo', piso: '2', numero: 449, departamento: '', barrio: Barrio.find_by_nombre('Liniers'), precio: 120000, moneda_id: 1, superficie: 80, ambientes: 3, tipo_propiedad_id: 1},
  {direccion: 'Av Paseo Colon', piso: '', numero: 850, departamento: '', barrio_id: 35, precio: 115000, moneda_id: 1, superficie: 75, ambientes: 3, tipo_propiedad_id: 1}])
