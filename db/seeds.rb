...
tipoPublicaciones = TipoPublicacion.create([{nombre: 'Gratuita'}, {nombre: 'Básica'}, {nombre: 'Premium'},])
  
propiedades = Propiedad.create([{direccion: 'PEDRO LOZANO', piso: 2, numero: 4100, departamento: 'A', descripcion: 'descripcio1', antiguedad: 1, operacion_id: 1, barrio_id: 2, precio: 150000, moneda_id: 2, superficie: 100, ambientes: 2, dormitorios: 2, expensas: 1200, tipo_propiedad_id: 2, user: usuarios.first, amenities: [amenities.first, amenities.second], tipo_publicacion_id: 1, fecha_publicacion: '2014-09-26 16:05:35'}, 
  {direccion: 'Av Corrientes', piso: '', numero: 4666, departamento: '', descripcion: 'descripcio2', antiguedad: 0, operacion_id: 2, barrio: Barrio.find_by_nombre('Flores'), precio: 100000, moneda_id: 1, superficie: 60, ambientes: 1, dormitorios: 1, expensas: 200, tipo_propiedad_id: 1, user: usuarios.first, superficie_nc: 100, tipo_publicacion_id: 2, fecha_publicacion: '2014-08-22 16:05:35'}, 
  {direccion: 'Murguiondo', piso: '2', numero: 449, departamento: '', descripcion: 'descripcio3', antiguedad: 5, operacion_id: 3, barrio: Barrio.find_by_nombre('Liniers'), precio: 120000, moneda_id: 1, superficie: 80, ambientes: 3, dormitorios: 3, expensas: 1500, tipo_propiedad_id: 6, user: usuarios.first, tipo_publicacion_id: 3, fecha_publicacion: '2014-08-26 12:15:10'},
  {direccion: 'Av Paseo Colon', piso: '', numero: 850, departamento: '', descripcion: 'descripcio4', antiguedad: 10, operacion_id: 1, barrio_id: 35, precio: 115000, moneda_id: 1, superficie: 75, ambientes: 3, dormitorios: 4, expensas: 1200, tipo_propiedad_id: 1, user: usuarios.second, superficie_nc: 20, tipo_publicacion_id: 1, fecha_publicacion: '2014-09-06 10:26:45'}])
