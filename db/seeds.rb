...
Propiedad.create([{direccion: 'PEDRO LOZANO al 4100', barrio_id: 2, precio: 150000, moneda_id: 2,superficie: 100, ambientes: 2, tipo_propiedad_id: 2}, 
  {direccion: 'Av Corrientes 4666', barrio: Barrio.find_by_nombre('Flores'), precio: 100000, moneda_id: 1,superficie: 60, ambientes: 1, tipo_propiedad_id: 1},
  {direccion: 'Murguiondo 449', barrio: Barrio.find_by_nombre('Liniers'), precio: 120000, moneda_id: 1, superficie: 80, ambientes: 3, tipo_propiedad_id: 1},
  {direccion: 'Av Paseo Colon 850', barrio_id: 35, precio: 115000, moneda_id: 1, superficie: 75, ambientes: 3, tipo_propiedad_id: 1}])
